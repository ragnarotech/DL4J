...
public class DigitTrainer_orig {
    
    private static Logger log = LoggerFactory.getLogger(DigitTrainer_orig.class);
    ...
    public static void main(String[] args) throws Exception{
        ...
        File file = new File("mnist-model.zip");
